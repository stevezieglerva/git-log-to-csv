...
1576592170,2019-12-17T09:16:10,2019,12,17,"Steve Ziegler",README.md,8,,
1576592170,2019-12-17T09:16:10,2019,12,17,"Steve Ziegler",sam-app/add_cw_log_error_metric/CloudFormationReplicator.py,1,sam-app,add_cw_log_error_metric
1576592605,2019-12-17T09:23:25,2019,12,17,"Steve Ziegler",sam-app/add_cw_log_error_metric/CloudFormationReplicator.py,3,sam-app,add_cw_log_error_metric
"""
...
"""
        ...
        # Assert
        expected = """epoch,timestamp,year,month,day,author,file,churn_count,dir_1,dir_2
1576592170,2019-12-17T09:16:10,2019,12,17,"Steve Ziegler",README.md,2,,
"""
        self.assertEqual(results, expected)
...
"""
        ...
        # Assert
        expected = """epoch,timestamp,year,month,day,author,file,churn_count,dir_1,dir_2
1576592170,2019-12-17T09:16:10,2019,12,17,"Steve Ziegler",test1/README.md,2,test1,
"""
        self.assertEqual(results, expected)
